...
# ---- 6. LLM（OpenAI 兼容接口，千问/DeepSeek 通用，只改这两行切换）----
...
def analyze_with_llm(hits, market_news, stock_news):
    if not LLM_API_KEY:
